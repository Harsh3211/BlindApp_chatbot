...
// Boxes to render on the screen after result!!!
  List<Widget> renderBoxes(Size screen, List recognitions, double imageheight,
      double imagewidth, int acc) {
    ...
    return recognitions.map(
      (re) {
        return Positioned(
          ...
          child: Container(
            decoration:
                re["confidenceInClass"] * 100 > acc // Only for above 50%
                    ? BoxDecoration(
            ...
            child: re["confidenceInClass"] * 100 >
                    acc //Only for images greater than 50%
                ? Text(
